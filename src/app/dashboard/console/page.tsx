    ...
    <div className="space-y-8 max-w-5xl mx-auto py-6 relative">
      ...
      <div className="bg-[#0b0b0e]/50 backdrop-blur-xl border border-zinc-800/80 p-8 rounded-3xl relative overflow-hidden glossy-glow shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
        ...
        <div className="relative z-10 space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-955/20 bg-blue-950/20 border border-blue-900/50 text-[9px] font-black text-blue-400 uppercase tracking-widest animate-pulse">
            <span className="w-1.5 h-1.5 rounded-full bg-blue-450 bg-blue-400" />
